...
## ['suderei', 'personally', 'hardware', 'software']
...
ID_OF_HOWTO_PAGE = ''
##2017-01-03-how-to-use-public-voit'
...
CLUE_TEXT_FOR_LINKED_IMAGES = {'english': '(click for a larger version)'}
