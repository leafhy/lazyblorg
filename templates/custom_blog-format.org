...
<!-- <title>#BLOG-NAME# - Homepage of #AUTHOR-NAME#</title> -->
  ...
  <header class="persistent-header">
      ...
      <nav class="entrypage-article-header-nav">
        ...
        <ul style="margin-left:0">#BLOG-NAME#</ul>
        <ul style="text-align:left;margin-top:50px;margin-bottom:0;padding:0">
        <ul style="list-style-type:none;">
        <img src="#BASE-URL#/images/social_style_3_rss-2-1.png" alt="RSS icon" />&nbsp;<span style="font-size:small">RSS feeds:</span>
        <li <span style="font-size:small"><a href="#BASE-URL#/feeds/lazyblorg-all.atom_1.0.links-only.xml">links only</a> (most reliable)</span></li>
        <li <span style="font-size:small"><a href="#BASE-URL#/feeds/lazyblorg-all.atom_1.0.links-and-teaser.xml">article teaser</a></span></li>
        <li <span style="font-size:small"><a href="#BASE-URL#/feeds/lazyblorg-all.atom_1.0.links-and-content.xml">full content</a></span></li>
        </ul>
        </ul>
        </span>
      </nav>
  ...
  <p>
      <ul style="margin-left:5px;margin-top:50px;margin-bottom:50px"> This blog is my tiny place.</ul>
...
#+BEGIN_EXPORT HTML
    ...
    <footer>
      <p><i>#BLOG-NAME#</i> is authored in <a href="//orgmode.org">Org mode</a> and generated by <a href="https://github.com/novoid/lazyblorg">lazyblorg</a>
...
#+BEGIN_EXPORT HTML
  <body>
	...
	<header>
      ...
      <!-- <a href="../../../../">#BLOG-NAME#</a><span style="padding-top:1em;">&nbsp;&nbsp;&nbsp;&nbsp;&raquo;<a href="#BASE-URL#/tags/">Tags</a>&nbsp;&nbsp;&nbsp;&nbsp;&raquo;
	      <a href="../../../">#ARTICLE-YEAR#</a>&nbsp;&ndash;&nbsp;<a href="../../">#ARTICLE-MONTH#</a>&nbsp;&ndash;&nbsp;<a href="../">#ARTICLE-DAY#</a></span> -->
          <a href="../../../../">#BLOG-NAME#</a><span style="padding-top:1em;">&nbsp;&nbsp;&nbsp;&nbsp;&raquo;<a href="#BASE-URL#/tags/">Tags</a>	    
       </span>
	  </nav>
	...
	<header>
	  ...
	  <nav class="temporal-article-header-nav">
	    ...
	    <!-- <a href="../"><img src="#BLOG-LOGO#" alt="#BLOG-NAME# logo" width="350" style="vertical-align:middle;"></a><span style="padding-top:1em;">&nbsp;&nbsp;&nbsp;&nbsp;&raquo;Tags</span> -->
          <a href="../">#BLOG-NAME#</a><span style="padding-top:1em;">&nbsp;&nbsp;&nbsp;&nbsp;&raquo;Tags</span>       
      </span>
	  </nav>
  ...
  <body>
	...
	<header>
	  ...
	  <nav class="temporal-article-header-nav">
        ...
        <a href="../../../../">#BLOG-NAME#</a><span style="padding-top:1em;">&nbsp;&nbsp;&nbsp;&nbsp;&raquo;<a href="../">Tags</a>&nbsp;&nbsp;&nbsp;&nbsp;&raquo;#ARTICLE-TITLE#</span>
